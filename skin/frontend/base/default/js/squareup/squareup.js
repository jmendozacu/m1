...
Squareup.callbacks = {
    ...
    cardNonceResponseReceived: function (errors, nonce, cardData) {
        ...
        if (errors) {
			...
			// 2019-01-01 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
			// For compatibility with GoMage Checkout.
        ...
        // 2019-01-01 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
		// «Improve the Square payment module for Magento 1: remove the «Pay with card» button from checkout»
		// https://www.upwork.com/ab/f/contracts/21275118
        jQuery(document).trigger('df.square.cardNonceResponseReceived');
        // payment.save();
        // 2019-01-01 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
		// «Improve the Square payment module for Magento 1: remove the «Pay with card» button from checkout»
		// https://www.upwork.com/ab/f/contracts/21275118
