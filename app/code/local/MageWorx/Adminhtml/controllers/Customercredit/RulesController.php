...
class MageWorx_Adminhtml_Customercredit_RulesController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function getConditionsAction()
    {
        ...
        $this->getResponse()->setBody(
                $this->getLayout()->createBlock('mageworx/customercredit_rules_edit_tab_conditions','customercredit.rules.conditions')->toHtml()
        );
    }
    ...
    public function getActionsAction()
    {
        ...
        // echo "<pre>"; print_r($this->getRequest()->getParams()); exit;
        $this->getResponse()->setBody(
                $this->getLayout()->createBlock('mageworx/customercredit_rules_edit_tab_actions','customercredit.rules.actions')->toHtml()
        );
    }
}
