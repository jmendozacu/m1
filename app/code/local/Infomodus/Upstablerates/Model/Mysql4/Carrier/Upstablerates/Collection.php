<?php
class Infomodus_Upstablerates_Model_Mysql4_Carrier_Upstablerates_Collection extends Varien_Data_Collection_Db
{
    ...
    public function __construct()
    {
        ...
        $this->_shipTable = Mage::getSingleton('core/resource')->getTableName('upstablerates_shipping/upstablerates');
