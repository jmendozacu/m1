...
class Magpleasure_Common_Helper_Magento extends Mage_Core_Helper_Abstract
{
    ...
    {
        return $this->getVersion() == self::EDITION_COMMUNITY;
    }
    ...
    {
        return $this->getVersion() == self::EDITION_PROFESSIONAL;
    }
    ...
    {
        return $this->getVersion() == self::EDITION_ENTERPRICE;
    }
    ...
    {
        return $this->getVersion() == self::EDITION_GO;
    }
