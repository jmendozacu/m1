            ...
            foreach($giftvoucherIds as $giftvouchers) {
                ...
                foreach($giftvouchers as $giftvoucherId) {
                    ...
                    if($giftvoucher->getId()) {
                        ...
                        $page->setFillColor(new Zend_Pdf_Color_Html('#000000'));
                        $this->_setFontRegular($page, 8);
                        $page->drawText(Mage::helper('giftvoucher')->__('TOTAL THE VALUE OF: '), 355, $this->y-150 , 'UTF-8');
                        $page->drawText(Mage::helper('giftvoucher')->__('.....................................'), 438, $this->y-151 , 'UTF-8');
                        $page->setFillColor(new Zend_Pdf_Color_Html('#ff7200'));
                        $this->_setFontBold($page, 18);
                        $page->drawText($currency->formatTxt($giftvoucher->getBalance()), 443, $this->y-150 , 'UTF-8');
