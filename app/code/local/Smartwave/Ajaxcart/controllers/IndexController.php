		...
		if($params['isAjax'] == 1){
			...
			try {
				...
				if (!$cart->getQuote()->getHasError()){
                    ...
                    $message = '<div class="msg" style="text-align:left;">'
                                .$this->__("You've just added this product to the cart:")
                                .'<p class="product-name theme-color">'
                                .Mage::helper('core')->htmlEscape($product->getName())
                                .'</p><div class="timer theme-color">'
                                .$autoclose
                                .'</div></div>';
                    if($grandTotal<100){
                        $message.= '<div class="msg" style="color:red;text-align:left;">
                                    We suggest adding some <a href="/accessories-iphone-ipad-ipod.html"><b>accessories</b></a> to your order to qualify you for <a href="/repairzoom-shipping-options#shipping_options"><b>free shipping</b></a> (Minimum order $100).
                                </div>';
                    }
