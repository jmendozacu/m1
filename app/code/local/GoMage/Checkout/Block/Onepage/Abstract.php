    ...
    public function getAddressesHtmlSelect($type)
    {
        if ($this->isCustomerLoggedIn()) {
            ...
            $select = $this->getLayout()->createBlock('core/html_select')
                ...
                ->setExtraParams('onchange="checkout.loadAddress(\'' . $type . '\', this.value, \'' . $this->getUrl('gomage_checkout/onepage/ajax', array('action' => 'load_address', 'form_key' => Mage::getSingleton('core/session')->getFormKey())) . '\')"')
                ->setValue($addressId)
                ->setOptions($options);
