...
// 1.0.0
if ($installer->tableExists($this->getTable('mageworx_orderspro_upload_files')) && !$installer->tableExists($this->getTable('mageworx_ordersedit/upload_files'))) {
    $installer->getConnection()->renameTable($this->getTable('mageworx_orderspro_upload_files'), $this->getTable('mageworx_ordersedit/upload_files'));
} elseif ($installer->tableExists($this->getTable('orderspro_upload_files')) && !$installer->tableExists($this->getTable('mageworx_ordersedit/upload_files'))) {
    $installer->getConnection()->renameTable($this->getTable('orderspro_upload_files'), $this->getTable('mageworx_ordersedit/upload_files'));
} else {
    $installer->run(
        "
