...
if (!$installer->tableExists($this->getTable('mageworx_ordersedit/order_status_history'))) {
    $table = $installer->getConnection()
        ...
        ->addColumn(
            'history_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'unsigned' => true,
            'nullable' => false,
            ), 'History ID'
        )
        ->addColumn(
            'creator_admin_user_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'unsigned' => true,
            'nullable' => false,
            ), 'Creator Admin User ID'
        )
        ->addColumn(
            'creator_firstname', Varien_Db_Ddl_Table::TYPE_VARCHAR, '32', array(
            'nullable' => false,
            ), 'Creator First Name'
        )
        ->addColumn(
            'creator_lastname', Varien_Db_Ddl_Table::TYPE_VARCHAR, '32', array(
            'nullable' => false,
            ), 'Creator Last Name'
        )
        ->addColumn(
            'creator_username', Varien_Db_Ddl_Table::TYPE_VARCHAR, '40', array(
            'nullable' => false,
            ), 'Creator User Name'
        )
        ->addIndex(
