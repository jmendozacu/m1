...
class MageWorx_OrdersEdit_Block_Adminhtml_Sales_Order_Totals extends Mage_Adminhtml_Block_Widget//Mage_Adminhtml_Block_Sales_Order_Create_Abstract
{
    ...
    {
        Mage::dispatchEvent(
            'mwoe_render_temp_totals_html_after', array(
            'block' => $this,
    ...
    public function getButtonsHtml()
    {
        ...
        /** @var MageWorx_OrdersEdit_Helper_Data $ordersEditHelper */
        $ordersEditHelper = Mage::helper('mageworx_ordersedit');
        $applyButtonTitle = $ordersEditHelper->isAutoInvoice() ? $this->__('Apply & Invoice') : $this->__('Apply');
        ...
        Mage::dispatchEvent(
            'mwoe_render_temp_totals_buttons_html_before', array(
            'block' => $this
            )
        );
