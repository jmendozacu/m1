    ...
    public function __construct($resource=null)
    {
        ...
        if (Mage::helper('mageworx_ordersedit')->isEnabled() && $this->getSelect()!==null) {
            $this->getSelect()->joinLeft(
                array('upload_files_tbl'=>$this->getTable('mageworx_ordersedit/upload_files')),
                'upload_files_tbl.history_id = main_table.entity_id',                    
                array('file_id'=>'entity_id', 'file_name', 'file_size')
            );     

            $this->getSelect()->joinLeft(
                array('order_status_history_tbl'=>$this->getTable('mageworx_ordersedit/order_status_history')),
            ...
            $this->getSelect()->joinLeft(
                array('admin_user_tbl'=>$this->getTable('admin/user')),
