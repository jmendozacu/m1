<?php
/**
 * AdvancedInvoiceLayout Invoice Controller Tests
 *
 * @section LICENSE
 ...
 * @version     2.5.3
 */
class Vianetz_AdvancedInvoiceLayout_Test_Controller_Invoice extends EcomDev_PHPUnit_Test_Case_Controller
{
    public function setUp()
    {
        ...
        $this->mockAdminUserSession(array('advancedinvoicelayout/actions/print_invoice'));
    }
    ...
    /**
     * @test
     * @loadFixture invoice.yaml
     */
    public function testControllerDispatchedIfInvoicePrinted()
    {
        $this->dispatch('advancedinvoicelayout/adminhtml_invoice/printpdf', array('invoice_id' => 9999));
     ...
     * @test
     */
    public function testRequestForwardedIfNoInvoiceIdGiven()
    {
        $this->dispatch('advancedinvoicelayout/adminhtml_invoice/printpdf');
     ...
     */
    public function testInvoiceControllerReturnsPdfHeader()
    {
        $this->dispatch('advancedinvoicelayout/adminhtml_invoice/printpdf', array('invoice_id' => 9999));
     ...
     */
    public function testInvoiceControllerForwardsToOriginalMagentoControllerIfModuleOutputDisabled()
    {
        $this->dispatch('advancedinvoicelayout/adminhtml_invoice/printpdf', array('invoice_id' => 9999));
        $this->assertRequestForwarded();
    }
     ...
     */
    public function testInvoiceControllerForwardsToOriginalMagentoControllerIfDocumentTypeDisabled()
    {
        $this->dispatch('advancedinvoicelayout/adminhtml_invoice/printpdf', array('invoice_id' => 1234));
        $this->assertRequestForwarded();
    }
     ...
     * @test
     */
    public function testInvoiceControllerLoadsDeniedLayoutHandleIfAclActionNotAllowed()
    {
        // Remove all acls.
