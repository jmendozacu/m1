<?php
/**
 * AdvancedInvoiceLayout Pdf Creditmemo rewrite model
 *
 * NOTE
 ...
 * @version     2.5.3
 */
class Vianetz_AdvancedInvoiceLayout_Model_Rewrite_Order_Pdf_Creditmemo extends Mage_Sales_Model_Order_Pdf_Creditmemo
{
    /**
    ...
    {
        if (Mage::helper('advancedinvoicelayout')->isModuleActive(Vianetz_AdvancedInvoiceLayout_Model_Source_Type::SOURCE_TYPE_CREDITMEMO) === false) {
