<?php
/**
 * AdvancedInvoiceLayout Pdf Invoice rewrite model
 *
 * NOTE
 ...
 * @version     2.5.3
 */
class Vianetz_AdvancedInvoiceLayout_Model_Rewrite_Order_Pdf_Invoice extends Mage_Sales_Model_Order_Pdf_Invoice
{
    /**
