<?php
/**
 * AdvancedInvoiceLayout Pdf Font Source Model
 *
 * @section LICENSE
 ...
 * @version     2.5.3
 */
class Vianetz_AdvancedInvoiceLayout_Model_System_Config_Source_Pdffont
{
    /**
    ...
    public function toOptionArray()
    {
        ...
        $configNode = Mage::getConfig()->getNode('default/advancedinvoicelayout/fonts');
        foreach ($configNode->children() as $themeNode) {
            $themeArray[] = array(
                'label' => $themeNode->getAttribute('title'),
                'value' => $themeNode->getAttribute('title')
            );
        }
