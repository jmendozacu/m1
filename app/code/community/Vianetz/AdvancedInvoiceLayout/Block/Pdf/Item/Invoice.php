<?php
/**
 * AdvancedInvoiceLayout Pdf Invoice Item block
 *
 * @section LICENSE
 ...
 *
 */
class Vianetz_AdvancedInvoiceLayout_Block_Pdf_Item_Invoice extends Vianetz_AdvancedInvoiceLayout_Block_Pdf_Item_Abstract
{
    /**
    ...
    {
        $this->setTemplate($this->_getTemplateFilePath('item' . DS . 'invoice.phtml'));
