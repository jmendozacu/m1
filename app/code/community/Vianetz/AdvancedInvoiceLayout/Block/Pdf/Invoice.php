 ...
 * @version     2.5.3
 */
class Vianetz_AdvancedInvoiceLayout_Block_Pdf_Invoice extends Vianetz_AdvancedInvoiceLayout_Block_Pdf_Abstract
{
    /**
    ...
    {
        $this->setTemplate($this->_getTemplateFilePath('invoice.phtml'));
    ...
    {
        return 'advancedinvoicelayout/invoice/' . $configPath;
    }
    ...
    public function getItemHtml(Mage_Core_Model_Abstract $sourceItem)
    {
        return $this->getLayout()
            ->createBlock('advancedinvoicelayout/pdf_item_invoice', '', array('item' => $sourceItem))
            ->toHtml();
    }
}
