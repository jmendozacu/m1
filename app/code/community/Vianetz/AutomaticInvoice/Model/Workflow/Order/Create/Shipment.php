<?php
/**
 * AutomaticInvoice Create Shipment Workflow Class
 *
 * NOTICE
 ...
 * @version     1.4.4
 */
class Vianetz_AutomaticInvoice_Model_Workflow_Order_Create_Shipment extends Vianetz_AutomaticInvoice_Model_Workflow_Order_Create_Abstract
{
    /**
     * @return string
     */
