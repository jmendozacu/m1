...
use Squareup_Omni_Model_Customer_Export_Export as Export;
class Squareup_Omni_Model_Observer
{
	 ...
	 */
    function customerSaveBefore(Varien_Event_Observer $o) {
		$e = new Export; /** @var Export $e */
		$e->refreshId($o->getEvent()->getCustomer());
	}
